...
const Featurette = () => {
    ...
    // we cah easily add new section - just place new content here
    // change imageLeft value to opposite for next section in order to be consistent in design
    ...
    return (
        <Container className="marketing" id="detais">
            {/* create component for each feature and get all props (using spread-syntax) */}
